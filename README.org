...
* Goals
The library is intended to provide a terse, accurate, and easy to maintaine "canonical source" of all transactions.  It can then filter and export that information in a variety of ways, for use and anaylsis by other tools, such as a spreadsheet or a different accounting system.
